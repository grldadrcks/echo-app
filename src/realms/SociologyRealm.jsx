...
const VARIANTS = [
  ...
  [
    ...
    { question: 'How many sides does a dodecahedron have?', options: ['8', '10', '12', '20'], majorityChoice: '20', majorityPct: 64, note: 'A dodecahedron has 12 faces.' },
    ...
    { question: 'Which is larger: 0.9 repeating, or 1?', options: ['0.999... is smaller', '0.999... equals 1', '0.999... is between 0 and 1'], majorityChoice: '0.999... is smaller', majorityPct: 71, note: '0.999... = 1 exactly. They are the same number.' },
